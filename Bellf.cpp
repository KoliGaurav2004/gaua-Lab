...
Gaurav@gaurav-HP-Laptop-15s-fq5xxx:~/DAA_Lab$ g++ belmon_ford_17.cpp
Gaurav@gaurav-HP-Laptop-15s-fq5xxx:~/DAA_Lab$ ./a.out
...
enter destination vertex : -1 for exit
-1
Gaurav@gaurav-HP-Laptop-15s-fq5xxx:~/DAA_Lab$
